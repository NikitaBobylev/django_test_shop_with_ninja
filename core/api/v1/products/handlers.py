...
from core.api.schemas import ApiResponse, ListPaginationResponce
...
def get_product_list_handler(request: HttpRequest,
    ...
    product_list = service.get_product_list(search=search,
                                            pagination=pagination_in)
    product_total: int = service.get_product_count(search=search)

    items: Iterable[ProductSchema] = [ProductSchema.from_entity(obj)
